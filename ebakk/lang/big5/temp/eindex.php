...
<table width="100%" border="0" cellspacing="8" cellpadding="3">
  <tr>
    ...
    <tr>
      <td><div align="center"><strong><font size="5">舧ㄏノ&nbsp;EmpireBak&nbsp;v2010</font></strong></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table width="420" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        <form name="form1" method="post" action="phome.php">
          ...
          <tr> 
            <td height="25" colspan="2"><div align="center"><strong><font color="#FFFFFF">恨瞶祅魁</font></strong></div></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="32%" height="25">ノめ</td>
		...
		?>
          <tr bgcolor="#FFFFFF"> 
            <td height="25">&nbsp;</td>
            <td height="25"><input type="submit" name="Submit" value="祅魁">&nbsp;&nbsp; <input type="reset" name="Submit2" value="竚"></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td height="25" colspan="2"><div align="center">(<a href="doc.html" target="_blank">琩瓣称弧ゅ郎</a>)</div></td>
          </tr>
        </form>
      </table></td>
    </tr>
